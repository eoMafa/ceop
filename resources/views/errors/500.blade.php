...
<head>
    ...
    <title>{{ config('app.name') }} - Erro interno</title>
    ...
    <div class="container-tight py-4">
        ...
        <div class="card card-md">
            <div class="card-body text-center py-5">
                ...
                <h2 class="h1 mb-2">Erro interno do servidor</h2>
                <p class="text-secondary mb-4">
                    Algo deu errado. Tente novamente em alguns instantes.<br>
        ...
        <div class="text-center mt-3 text-secondary">
            <small>Erro 500 — Erro interno do servidor</small>
        </div>
    </div>
</body>
</html>